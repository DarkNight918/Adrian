...
export const projects = [
  {
    ...
    description:
      "Register user's income and make you know financial reports day, month and year.",
  ...
  },
  {
    ...
    description:
      "Supporting designing the clothes and price with fashion component.",
    image: Django,
...
export const workExperience = [
  {
    ...
    company: "Almosafter",
    description: [
      "Updated the first generation of Almosafer website & mobile iOS/Android app",
  ...
  },
  {
    ...
    company: "Legably",
    description: [
      "Developed a job market platform with MERN.",
  ...
  },
  {
    ...
    description: [
      "Maintained multiple live websites",
...
export const education = [
  {
    ...
    school: "Sumy State University",
    description:
      "Learned Web Development and AI & ML and awarded bachelor of Computer Science",
    from: "2012 - ",
    to: "2016",
  },
];
